    ...
    public function runSet(Net_Gearman_Set $set, $timeout = null)
    {
        ...
        while (!$this->set->finished()) {
            ...
            if ($t < $totalTasks) {
                ...
                if ($this->set->tasks[$k]->type == Net_Gearman_Task::JOB_BACKGROUND ||
                    $this->set->tasks[$k]->type == Net_Gearman_Task::JOB_HIGH_BACKGROUND ||
                    $this->set->tasks[$k]->type == Net_Gearman_Task::JOB_LOW_BACKGROUND
                ) {
